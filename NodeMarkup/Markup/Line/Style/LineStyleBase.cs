...
namespace NodeMarkup.Manager
{
    ...
    public abstract class RegularLineStyle : LineStyle<RegularLineStyle>
    {
        public static Dictionary<RegularLineType, RegularLineStyle> Defaults { get; } = new Dictionary<RegularLineType, RegularLineStyle>()
        {
            ...
            {RegularLineType.Text, new RegularLineStyleText(DefaultColor, string.Empty, FontStyle.Normal, string.Empty, DefaultTextScale, DefaultObjectAngle, DefaultObjectShift, RegularLineStyleText.TextDirection.Horizontal, Vector2.zero)},
