...
namespace NodeMarkup.UI.Editors
{
    ...
    //        }
    //        else
    //            item = GetItem(ItemsPanel.Content);
    ...
    //    {
    //        var group = ItemsPanel.Content.AddUIComponent<EditableGroupType>();
    //        group.Init(groupType, GroupName(groupType));
    //        group.width = ItemsPanel.Content.width;
    ...
    //    {
    //        var components = ItemsPanel.Content.components.ToArray();
    ...
    //        if (GroupingEnabled)
    //        {
    //            foreach (var group in ItemsPanel.Content.components.OfType<EditableGroupType>())
    //                group.Refresh();
    //        }
    //        else
    //            base.RefreshItems();
    ...
    //        ItemsPanel.Content.ScrollIntoViewRecursive(item);
    //    }
    //}
}
