...
namespace NodeMarkup.Utils
{
    ...
    public static class Utilities
    {
        ...
        public static Vector4 ToX3Vector(this Color c) => new Vector4(ColorChange(c.r), ColorChange(c.g), ColorChange(c.b), Mathf.Pow(c.a, 2) /*(1 - Mathf.Pow(1 - Mathf.Pow(c.a, 3), 1.1f)) * 0.99f + 0.01f*/);
