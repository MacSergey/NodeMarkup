...
namespace IMT.Manager
{
    public abstract class RegularLineStyle : LineStyle<RegularLineStyle>
    {
        private static Dictionary<RegularLineType, RegularLineStyle> Defaults { get; } = new Dictionary<RegularLineType, RegularLineStyle>()
        {
            ...
            {RegularLineType.Text, new RegularLineStyleText(DefaultColor, DefaultEffect, DefaultEffect, DefaultTexture, string.Empty, string.Empty, DefaultTextScale, DefaultObjectAngle, DefaultObjectShift, RegularLineStyleText.TextDirection.LeftToRight, Vector2.zero, RegularLineStyleText.TextAlignment.Middle, 0f)},
            {RegularLineType.Network, new NetworkLineStyle(null, null, DefaultObjectShift, DefaultObjectElevation, DefaultNetworkScale, DefaultObjectOffsetBefore, DefaultObjectOffsetAfter, DefaultRepeatDistance, false) },
        };
