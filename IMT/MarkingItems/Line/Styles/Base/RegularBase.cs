...
namespace IMT.Manager
{
    public abstract class RegularLineStyle : LineStyle<RegularLineStyle>
    {
        private static Dictionary<RegularLineType, RegularLineStyle> Defaults { get; } = new Dictionary<RegularLineType, RegularLineStyle>()
        {
            ...
            {RegularLineType.Network, new NetworkLineStyle(null, null, new Vector2(DefaultObjectShift,DefaultObjectShift), new Vector2(DefaultObjectElevation, DefaultObjectElevation), DefaultNetworkScale, DefaultObjectOffsetBefore, DefaultObjectOffsetAfter, DefaultRepeatDistance, false) },
        };
