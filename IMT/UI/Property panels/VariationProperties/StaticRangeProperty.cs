...
namespace IMT.UI
{
    public abstract class StaticRangeProperty<ValueType, FieldType, RangeType, RefType> : EditorPropertyPanel, IReusable
    ...
    public class FloatStaticRangeProperty : StaticRangeProperty<float, FloatUITextField, FloatRangeField, IValueFieldRange<float>> { }
}
