...
namespace IMT.UI
{
    public abstract class StaticRangeAutoProperty<ValueType, FieldType, RangeType, RefType> : EditorPropertyPanel, IReusable
    ...
    public class FloatStaticRangeAutoProperty : StaticRangeAutoProperty<float, FloatUITextField, FloatRangeField, IValueFieldRange<float>> { }
}
